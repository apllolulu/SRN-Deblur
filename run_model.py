...
"""
train : python run_model.py --phase=train --batch_size=2 --lr=1e-4 --epoch=1000   --model=lstm --architecture=ResnetBlock


test:   python run_model.py --input_path=./testing_set --output_path=./testing_res
...
def parse_args():
    ...
    parser.add_argument('--architecture', type=str, default='SE_ResNeXt', help='architecture type: [ResnetBlock | SE_ResNeXt]')
