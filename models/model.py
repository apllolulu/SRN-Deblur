...
class DEBLUR(object):
    def __init__(self, args):
        ...
        #print("train_dir:",self.train_dir)  # ./checkpoints/SE
            ...
            with slim.arg_scope([slim.conv2d, slim.conv2d_transpose],
                ...
                for i in range(self.n_levels):
                    ...
                    if self.args.architecture == 'ResnetBlock':
                        ...
                        elif self.args.model == 'SE':
                            with tf.variable_scope('SE'):
                                deconv3_4 = Squeeze_excitation_layer(conv3_4, 128, self.ratio, 'SE')
                        else:
                            deconv3_4 = conv3_4


                        #deconv3_4, rnn_state = cell(conv3_4, rnn_state)
                        #print("deconv3_4.shape",deconv3_4.shape)  # (16, 16, 16, 128)
                    ...
                    if self.args.architecture == 'SE_ResNeXt':
                        deconv1_1,rnn_state= SE_ResNeXt(inp_all,cell,rnn_state, training=self.training,scope='se_resnet').encoder_decoder

                        inp_pred = slim.conv2d(deconv1_1, self.chns, [3, 3], activation_fn=None, scope='se_pred')
                        #print("inp_pred.shape:",inp_pred.shape) # inp_pred.shape: (16, 16, 16, 1)
